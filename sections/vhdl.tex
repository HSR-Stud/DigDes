...
\begin{multicols}{2}
	...
	\begin{center}
		\includegraphics[width=0.13\textwidth]{pics/fsmprocesslogic}
	\end{center}
	\begin{itemize}
		\itemsep0em
...
\begin{multicols}{2}
	...
	\itemsep0em
		...
		\begin{itemize}
			...
			\item[\-] % Bild gehört zu vorhergehendem Abschnitt 'Arithmetik', aus Formatierungsgründen ist es hier eingefügt.
